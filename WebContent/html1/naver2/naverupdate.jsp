...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="pwd" value="<%=dto.getPwd() %>" size="20" maxlength="3" class="txtField"/>
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="name" value="<%=dto.getName() %>" size="20" maxlength="3" class="txtField"/>
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="birth1" value="<%=dto.getBirth1() %>" size="20" maxlength="3" class="txtField"/>
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="birth2" value="<%=dto.getBirth2() %>" size="20" maxlength="3" class="txtField"/>
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="birth3" value="<%=dto.getBirth3() %>" size="20" maxlength="3" class="txtField"/>
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="gender" value="<%=dto.getGender() %>" size="20" maxlength="3" class="txtField"/>
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="email" value="<%=dto.getEmail() %>" size="20" maxlength="3" class="txtField"/>
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="choice" value="<%=dto.getChoice() %>" size="20" maxlength="3" class="txtField"/>
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="tel" value="<%=dto.getTel() %>" size="20" maxlength="3" class="txtField"/>
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="phone" value="<%=dto.getPhone() %>" size="20" maxlength="3" class="txtField"/>
	</td>
</tr>
