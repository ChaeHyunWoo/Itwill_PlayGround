...
<tr height="35">
	...
	onclick="javascript:location.href='<%=cp%>/naver/write.jsp'"/>
	</td>
</tr>
</table>
...
<tr height="30">
	...
	<td align="center" bgcolor="#e6e6e6" width="130">국가</td>
	<td align="center" bgcolor="#e6e6e6" width="130">전화번호</td>
	<td align="center" bgcolor="#e6e6e6" width="130">인증번호</td>
	<td align="center" bgcolor="#e6e6e6" width="130">수정/삭제</td>
</tr>
