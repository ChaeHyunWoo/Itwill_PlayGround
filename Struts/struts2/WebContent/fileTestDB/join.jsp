...
<link rel="stylesheet" type="text/css" href="<%=cp%>/fileTestDB/css/created.css"/>

<script type="text/javascript" src="<%=cp%>/fileTestDB/js/util.js"></script>
...
<script type="text/javascript">
	...
	function sendIt() {
		...
		f.action = "<%=cp%>/fileTestDB/join_ok.action";
		f.submit();
	...
	<div id="bbsCreated">
		...
		<div class="bbsCreated_bottomLine">
			<dl>
				<dt>패스워드</dt>
				<dd>
				<input type="text" name="userPwd" size="35" 
				maxlength="20" class="boxTF">
				</dd>
			</dl>
		</div>	
